...
## This is readme file of brooklyn project.
--------------------------------------------
...
> 0. (Done) Meta Box (https://wordpress.org/plugins/meta-box/) (Active)

> 1. (Done) W3 Total Cache https://wordpress.org/plugins/w3-total-cache/) (Active)

> 2. (Done) WP Migrate DB (https://wordpress.org/plugins/wp-migrate-db/) (Active)

--------------------------------------------

> Theme list:

> 0. (Done) Twentytwelve (http://wordpress.org/themes/twentytwelve)
...
1. Defined constant below in wp-config.php new file
    >  define('WP_HOME','http://ecba.local');
    >
    >  define('WP_SITEURL','http://ecba.local');
